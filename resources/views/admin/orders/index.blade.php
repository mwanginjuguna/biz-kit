    ...
    <div class="max-w-6xl mx-auto px-4 py-10 md:py-16">
        ...
        <div class="py-10">
            ...
            <div class="grid lg:grid-cols-3 border border-slate-200 shadow-sm rounded-xl overflow-hidden dark:border-slate-800">
                <!-- Orders Card -->
                <a class="block p-4 md:p-5 relative bg-orange-200 hover:bg-orange-100 before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:w-px md:before:h-full before:bg-gray-200 before:first:bg-transparent dark:bg-orange-700 dark:hover:bg-orange-900 dark:before:bg-orange-800" href="#">
                        ...
                        <div class="grow">
                            ...
                            <div class="mt-1 flex justify-between items-center">
                                ...
                                <span class="ms-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-lime-300 text-slate-800 dark:bg-lime-600 dark:text-slate-100">
                                    <span class="inline-block">{{ number_format($paid/$all * 100, 2) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex md:grid lg:flex gap-y-3 gap-x-5">
                        ...
                        <div class="grow">
                            ...
                            <div class="mt-1 flex justify-between items-center">
                                ...
                                <span class="ms-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-lime-300 text-slate-800 dark:bg-lime-600 dark:text-slate-100">
                                    <span class="inline-block">{{ number_format($cus/$users * 100, 2) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
                ...
                <a class="block p-4 md:p-5 relative bg-orange-200 hover:bg-orange-100 before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:w-px md:before:h-full before:bg-gray-200 before:first:bg-transparent dark:bg-orange-700 dark:hover:bg-orange-900 dark:before:bg-orange-800" href="#">
                    <div class="flex md:grid lg:flex gap-y-3 gap-x-5">
                        ...
                        <div class="grow">
                            ...
                            <div class="mt-1 flex justify-between items-center">
                                <p class="text-xs text-slate-600 dark:text-slate-300">
                                    Sold products: <span class="text-sm font-medium text-green-600 dark:text-green-400">{{ $us = $purchasedProducts }}</span>
                                </p>
                                <span class="ms-1 inline-flex items-center gap-1.5 py-1 px-2 rounded-md text-xs font-medium bg-lime-300 text-slate-800 dark:bg-lime-600 dark:text-slate-100">
                                    <span class="inline-block">{{ number_format($purchasedProducts/$products * 100, 2) }}%</span>
                                </span>
                            </div>
                        </div>
                    </div>
