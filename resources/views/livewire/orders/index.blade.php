        ...
        >
            <div class="col-span-1 text-sm px-3 flex flex-col gap-y-2">
                <div class="flex flex-row gap-x-4 border-b">
                    ...
                    <a href="{{route('orders.show', $order->id)}}" class="text-blue-500 hover:underline underline-offset-2 hover:text-blue-600 flex">
            ...
            <div class="col-span-2 pl-2 border-l">
                <div class="">
                    <p class="font-semibold text-amber-800">
                        ...
                        @else
                            <span class="text-red-700 uppercase">
                                Not Paid
                            </span>
                        @endif
                    </p>
            ...
            <a href="{{ route('orders.show', $order->id) }}" class="col-span-3 mt-1 px-5 text-right text-sm underline underline-offset-4 decoration-dotted text-blue-500 hover:text-blue-600">View Order</a>
        </div>
    @endforeach
