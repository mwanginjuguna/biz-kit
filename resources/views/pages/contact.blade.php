<x-guest-layout>
    ...
    <div class="max-w-6xl mx-auto">
        <!-- Contact -->
        <div class="px-4 lg:px-6 lg:px-8 py-12 lg:py-24 mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-6 md:gap-8 lg:gap-12">
                <div class="aspect-w-16 aspect-h-6 lg:aspect-h-14 overflow-hidden bg-gray-100 rounded-2xl dark:bg-neutral-800">
                    <img class="group-hover:scale-105 transition-transform duration-500 ease-in-out object-cover rounded-2xl" src="https://images.unsplash.com/photo-1446776899648-aa78eefe8ed0" alt="Image Description">
                </div>
                <!-- End Col -->
