<div>
    ...
    <div id="toast-info" class="flex items-center w-full max-w-xs p-4 text-slate-500 bg-white rounded-lg shadow dark:text-slate-400 dark:bg-slate-800" role="alert">
