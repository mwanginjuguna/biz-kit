<div id="cta-button-sidebar"
    ...
    <div class="min-h-screen px-3 py-10 overflow-y-auto bg-slate-50 dark:bg-slate-900">
        ...
        <ul class="mt-6 space-y-2 font-medium text-sm xL:text-base">
            ...
            @if(auth()->user()->role === 'A')
                <li>
                    <a href="{{ route('admin.orders') }}" class="flex items-center p-2 text-slate-900 dark:text-slate-100 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 group" wire:navigate>
