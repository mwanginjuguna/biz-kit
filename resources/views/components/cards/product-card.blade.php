...
<div class="w-full max-w-sm bg-slate-50 border border-slate-200 rounded-lg shadow dark:bg-slate-800 dark:border-slate-700">
    <img class="w-full rounded-t-lg" src="/storage/{{ $product->image }}" alt="product image" />
    <div class="py-1 px-5 pb-5">
        <a href="{{ route('products.show', $product->slug) }}" class="hover:underline text-orange-500">
